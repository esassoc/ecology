import{i as r,b as s,a}from"./lit-element.D8DSg5zn.js";class i extends r{constructor(){super(),this.scrollHandler=null,this.scrollToTop=()=>{const o=this.smoothScroll?"smooth":"auto",t=this.scrollTarget;t?t.scrollTo({top:0,behavior:o}):window.scrollTo({top:0,behavior:o})},this.threshold=300,this.smoothScroll=!0,this.scrollTarget=null,this.visible=!1}static{this.properties={threshold:{type:Number},smoothScroll:{type:Boolean,attribute:"smooth-scroll"},scrollTarget:{attribute:!1},visible:{type:Boolean,reflect:!0}}}connectedCallback(){super.connectedCallback(),this.scrollHandler=()=>{const t=this.scrollTarget,e=(t?t.scrollTop:window.scrollY||document.documentElement.scrollTop)>this.threshold;e!==this.visible&&(this.visible=e)},(this.scrollTarget||window).addEventListener("scroll",this.scrollHandler,{passive:!0}),this.scrollHandler()}disconnectedCallback(){super.disconnectedCallback(),this.scrollHandler&&((this.scrollTarget||window).removeEventListener("scroll",this.scrollHandler),this.scrollHandler=null)}render(){return s`
      <button
        class="button"
        part="button"
        type="button"
