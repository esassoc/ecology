import{i as o,b as a,a as r}from"./lit-element.D8DSg5zn.js";import{t as n}from"./typography.KBHeYOQc.js";import{a as l}from"./announcer.dkeh-00N.js";import{b as s}from"./boolish.DOQu-9JQ.js";const g='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m17 18-6-6 6-6"/><path d="M7 6v12"/></svg>',c='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',p='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>',d='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 18 6-6-6-6"/><path d="M17 6v12"/></svg>';class h extends o{constructor(){super(),this.goToFirst=()=>{this.disabled||this.isFirstPage||this.emitPageChange(0)},this.goToPrevious=()=>{this.disabled||this.isFirstPage||this.emitPageChange(this.currentPage-1)},this.goToNext=()=>{this.disabled||this.isLastPage||this.emitPageChange(this.currentPage+1)},this.goToLast=()=>{this.disabled||this.isLastPage||this.emitPageChange(this.totalPages-1)},this.onPageSizeChange=t=>{const e=Number(t.target.value);isNaN(e)||this.disabled||(this.pageSize=e,this.dispatchEvent(new CustomEvent("pagesizechange",{detail:{pageSize:e},bubbles:!0,composed:!0})),this.emitPageChange(0))},this.totalItems=0,this.pageSize=25,this.currentPage=0,this.pageSizeOptions=[10,25,50,100],this.showPageSizeSelector=!0,this.showFirstLastButtons=!0,this.disabled=!1}static{this.properties={totalItems:{type:Number,attribute:"total-items"},pageSize:{type:Number,attribute:"page-size"},currentPage:{type:Number,attribute:"current-page"},pageSizeOptions:{type:Array,attribute:"page-size-options"},showPageSizeSelector:{type:Boolean,attribute:"show-page-size-selector",converter:s},showFirstLastButtons:{type:Boolean,attribute:"show-first-last-buttons",converter:s},disabled:{type:Boolean,reflect:!0}}}get totalPages(){return Math.max(1,Math.ceil(this.totalItems/this.pageSize))}get rangeLabel(){const t=this.totalItems;if(t===0)return"0 of 0";const e=this.currentPage*this.pageSize+1,i=Math.min((this.currentPage+1)*this.pageSize,t);return`${e} – ${i} of ${t.toLocaleString()}`}get isFirstPage(){return this.currentPage===0}get isLastPage(){return this.currentPage>=this.totalPages-1}emitPageChange(t){this.currentPage=t,this.dispatchEvent(new CustomEvent("pagechange",{detail:{page:t},bubbles:!0,composed:!0})),l(`Page ${t+1} of ${this.totalPages}. Showing ${this.rangeLabel}.`),this.updateComplete.then(()=>{const e=this.renderRoot.activeElement;if(!e||!e.disabled)return;this.renderRoot.querySelector("button:not([disabled])")?.focus()})}render(){return a`
  ...
  `]}}customElements.get("esa-pagination")||customElements.define("esa-pagination",h);
