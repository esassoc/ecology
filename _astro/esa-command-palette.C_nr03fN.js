                ...
                ${o.commands.map(t=>s`
                    ...
                    >
                      <div class="esa-command-palette__item-content">
                        ...
                        ${t.description?s`<span class="esa-command-palette__item-desc">${t.description}</span>`:null}
                      </div>
                      ${t.shortcut?s`<kbd class="esa-command-palette__item-shortcut">${t.shortcut}</kbd>`:null}
                    </button>
                  `)}
              </div>
            `)}
          ${e.length===0?s`<div class="esa-command-palette__empty">No commands found for "${this.query}"</div>`:null}
        </div>
      </div>
