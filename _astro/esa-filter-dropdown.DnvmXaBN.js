      ...
      <div class="esa-filter-dropdown">
        ...
        ${this._open?o`<div class="esa-filter-dropdown__panel" role="listbox">
              ...
              <ul class="esa-filter-dropdown__options" role="listbox">
                ${e.length===0?o`<li class="esa-filter-dropdown__option esa-filter-dropdown__option--disabled">
                      No options available
                    </li>`:e.map((t,i)=>o`<li
                        class="esa-filter-dropdown__option
                          ${t.disabled?"esa-filter-dropdown__option--disabled":""}
                          ${this.isSelected(t.value)?"esa-filter-dropdown__option--selected":""}
                      ...
                      >
                        ${this.multiple?o`<span
                              class="esa-filter-dropdown__check ${this.isSelected(t.value)?"esa-filter-dropdown__check--selected":""}"
                              >&#10003;</span
                            >`:null}
                        ${t.label}
                      </li>`)}
