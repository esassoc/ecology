import{i as n,b as o,a as l}from"./lit-element.D8DSg5zn.js";import"./esa-checkbox.BVSV47iN.js";class d extends n{constructor(){super(),this.onDocClick=e=>{this._open&&!e.composedPath().includes(this)&&(this._open=!1)},this.onDocKeydown=e=>{e.key==="Escape"&&this._open&&(this._open=!1)},this.togglePanel=()=>{const e=!this._open;this._open=e,e&&(this._highlighted=-1,requestAnimationFrame(()=>{this.renderRoot?.querySelector(".esa-filter-dropdown__search-input")?.focus()}))},this.onSearchInput=e=>{this._searchText=e.target.value,this._highlighted=-1},this.onKeydown=e=>{const r=this.filteredOptions,i=r.length-1;let t=this._highlighted;switch(e.key){case"ArrowDown":for(e.preventDefault(),t=t<i?t+1:0;r[t]?.disabled&&t<i;)t++;this._highlighted=t;break;case"ArrowUp":for(e.preventDefault(),t=t>0?t-1:i;r[t]?.disabled&&t>0;)t--;this._highlighted=t;break;case"Enter":e.preventDefault(),t>=0&&t<=i&&this.selectOption(r[t]);break;case"Escape":this._open=!1;break}},this.clear=e=>{e.stopPropagation(),this._selected=[],this.emitChange([])},this.name="",this.label="",this.options=[],this.multiple=!1,this.placeholder="",this.size="md",this._open=!1,this._searchText="",this._selected=[],this._highlighted=-1}static{this.properties={name:{type:String},label:{type:String},options:{type:Array},multiple:{type:Boolean,reflect:!0},placeholder:{type:String},size:{type:String,reflect:!0},_open:{state:!0},_searchText:{state:!0},_selected:{state:!0},_highlighted:{state:!0}}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this.onDocClick,!0),document.addEventListener("keydown",this.onDocKeydown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this.onDocClick,!0),document.removeEventListener("keydown",this.onDocKeydown)}get filteredOptions(){const e=this._searchText.toLowerCase();return e?this.options.filter(r=>r.label.toLowerCase().includes(e)):this.options}get hasSelection(){return this._selected.length>0}get buttonLabel(){if(this.multiple||this._selected.length===0)return this.label;const e=this.options.find(r=>r.value===this._selected[0]);return`${this.label}: ${e?.label??this._selected[0]}`}isSelected(e){return this._selected.includes(e)}selectOption(e){if(e.disabled)return;const r=e.value;if(this.multiple){const t=this._selected.indexOf(r)>=0?this._selected.filter(a=>a!==r):[...this._selected,r];this._selected=t,this._searchText="",this.emitChange(t),requestAnimationFrame(()=>{this.renderRoot?.querySelector(".esa-filter-dropdown__search-input")?.focus()})}else this._selected=[r],this._searchText="",this._open=!1,this.emitChange([r])}emitChange(e){const r=this.multiple?e:e[0]??void 0;this.dispatchEvent(new CustomEvent("selection-change",{detail:{value:r},bubbles:!0,composed:!0}));const i=e.map(t=>{const a=this.options.find(s=>s.value===t);return{name:this.name,label:this.label,value:t,displayValue:a?.label??t}});this.dispatchEvent(new CustomEvent("esa-filter-change",{detail:{name:this.name,filters:i},bubbles:!0,composed:!0}))}render(){const e=this.filteredOptions;return o`
      <div class="esa-filter-dropdown">
        ...
        ${this._open?o`<div class="esa-filter-dropdown__panel" role="listbox">
              ...
              <div class="esa-filter-dropdown__options" role="group" aria-label=${this.label}>
                ${e.length===0?o`<div class="esa-filter-dropdown__empty">No options match.</div>`:e.map((r,i)=>o`<div
  ...
  `}}const c=o`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m6 9 6 6 6-6" /></svg>`;customElements.get("esa-filter-dropdown")||customElements.define("esa-filter-dropdown",d);
