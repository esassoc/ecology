import{i as a,b as o,a as s}from"./lit-element.C8p3bJxG.js";class l extends a{static{this.properties={files:{type:Array},removable:{type:Boolean,reflect:!0},downloadable:{type:Boolean,reflect:!0}}}constructor(){super(),this.files=[],this.removable=!1,this.downloadable=!0}emit(e,t,r){this.dispatchEvent(new CustomEvent(e,{detail:{file:t,index:r},bubbles:!0,composed:!0}))}onRemove(e){const t=this.files[e];this.files=this.files.filter((r,n)=>n!==e),this.emit("remove",t,e)}render(){return this.files.length?o`
      <ul class="list">
