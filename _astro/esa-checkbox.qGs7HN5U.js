import{w as t,i,b as e,a as s}from"./lit-element.D8DSg5zn.js";import{t as r}from"./typography.KBHeYOQc.js";import{a}from"./a11y.sqk3bMt7.js";const c={xs:"body-2xs",sm:"body-xs",md:"body-md",lg:"body-lg"},n=t`<polyline points="20 6 9 17 4 12"></polyline>`,l=t`<line x1="5" y1="12" x2="19" y2="12"></line>`;class d extends i{constructor(){super(),this.toggle=()=>{this.disabled||(this.checked=!this.checked,this.syncFormValue(),this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0})))},this.onKeydown=o=>{(o.key===" "||o.key==="Enter")&&(o.preventDefault(),this.toggle())},this.label="",this.size="md",this.disabled=!1,this.indeterminate=!1,this.checked=!1,this.internals=this.attachInternals()}static{this.formAssociated=!0}static{this.properties={label:{type:String},size:{type:String,reflect:!0},disabled:{type:Boolean,reflect:!0},name:{type:String,reflect:!0},indeterminate:{type:Boolean,reflect:!0},checked:{type:Boolean,reflect:!0}}}connectedCallback(){super.connectedCallback(),this.syncFormValue()}syncFormValue(){this.internals.setFormValue(this.checked?"on":null),this.internals.ariaChecked=this.indeterminate?"mixed":String(this.checked)}render(){return e`
      <label class="wrapper" @keydown=${this.onKeydown} @click=${this.toggle}>
        ...
        ${this.label?e`<span class="label typography-${c[this.size]}">${this.label}</span>`:null}
      </label>
    `}static{this.styles=[r,a,s`
    :host {
      --_checkbox-size: 20px;
  ...
  `]}}customElements.get("esa-checkbox")||customElements.define("esa-checkbox",d);
