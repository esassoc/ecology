import{w as c,i as l,b as t,a as n}from"./lit-element.D8DSg5zn.js";import{t as d}from"./typography.D6s5VeQm.js";const h={xs:"label-2xs",sm:"label-xs",md:"label-md",lg:"label-lg"},b={xs:"body-2xs",sm:"body-xs",md:"body-md",lg:"body-lg"},u=c`<polyline points="20 6 9 17 4 12"></polyline>`;class p extends l{constructor(){super(),this.toggleOption=e=>{if(e.disabled)return;const s=this.value.indexOf(e.value);this.value=s>=0?this.value.filter(o=>o!==e.value):[...this.value,e.value],this.syncFormValue(),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))},this.onKeydown=(e,s)=>{(e.key===" "||e.key==="Enter")&&(e.preventDefault(),this.toggleOption(s))},this.options=[],this.label="",this.size="md",this.orientation="vertical",this.value=[],this.internals=this.attachInternals()}static{this.formAssociated=!0}static{this.properties={options:{type:Array},label:{type:String},size:{type:String,reflect:!0},orientation:{type:String,reflect:!0},name:{type:String,reflect:!0},value:{type:Array}}}willUpdate(e){if(e.has("options")&&typeof this.options=="string")try{this.options=JSON.parse(this.options)}catch{this.options=[]}(e.has("value")||e.has("name"))&&this.syncFormValue()}connectedCallback(){super.connectedCallback(),this.syncFormValue()}syncFormValue(){const e=new FormData,s=this.name||"checkbox-group";for(const o of this.value)e.append(s,o);this.internals.setFormValue(e)}isChecked(e){return this.value.includes(e)}render(){return t`
  ...
  `]}}customElements.get("esa-checkbox-group")||customElements.define("esa-checkbox-group",p);const r=document.getElementById("cbg-form");r?.addEventListener("submit",i=>{i.preventDefault();const e=new FormData(r);document.getElementById("cbg-out").textContent="media = "+JSON.stringify(e.getAll("media"))});
