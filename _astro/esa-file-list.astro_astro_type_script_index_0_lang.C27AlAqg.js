import{i as n,b as o,a as l}from"./lit-element.D8DSg5zn.js";import{t as s}from"./typography.KBHeYOQc.js";class d extends n{static{this.properties={files:{type:Array},removable:{type:Boolean,reflect:!0},downloadable:{type:Boolean,reflect:!0}}}constructor(){super(),this.files=[],this.removable=!1,this.downloadable=!0}emit(e,t,r){this.dispatchEvent(new CustomEvent(e,{detail:{file:t,index:r},bubbles:!0,composed:!0}))}onRemove(e){const t=this.files[e];this.files=this.files.filter((r,a)=>a!==e),this.emit("remove",t,e)}render(){return this.files.length?o`
      <ul class="list">
