import{i as r,A as i,b as a,a as s}from"./lit-element.D8DSg5zn.js";import{t as o}from"./typography.KBHeYOQc.js";import{a as n}from"./a11y.sqk3bMt7.js";const l={xs:"label-2xs",sm:"label-xs",md:"label-md",lg:"label-lg"},c={xs:"microcopy-2xs",sm:"microcopy-xs",md:"microcopy-md",lg:"microcopy-lg"};class h extends r{constructor(){super(),this.onInput=e=>{const t=Number(e.target.value);this.value=t,this.internals.setFormValue(String(t)),this.dispatchEvent(new CustomEvent("change",{detail:{value:t},bubbles:!0,composed:!0}))},this.min=0,this.max=100,this.step=1,this.size="md",this.label="",this.showValue=!0,this.disabled=!1,this.value=0,this.internals=this.attachInternals()}static{this.formAssociated=!0}static{this.properties={min:{type:Number},max:{type:Number},step:{type:Number},size:{type:String,reflect:!0},label:{type:String},showValue:{type:Boolean,attribute:"show-value"},disabled:{type:Boolean,reflect:!0},name:{type:String,reflect:!0},value:{type:Number}}}connectedCallback(){super.connectedCallback(),this.internals.setFormValue(String(this.value))}willUpdate(e){e.has("value")&&this.internals.setFormValue(String(this.value))}get fillPercent(){return this.max===this.min?0:(this.value-this.min)/(this.max-this.min)*100}render(){return a`
      ${this.label?a`<label for="input" class="label typography-${l[this.size]}"
            >${this.label}</label
          >`:null}
      <div class="row">
        ...
        ${this.showValue?a`<span class="value typography-${c[this.size]}">${this.value}</span>`:null}
      </div>
  ...
  `]}}customElements.get("esa-range-slider")||customElements.define("esa-range-slider",h);
