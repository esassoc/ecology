import{i as r,b as a,a as i}from"./lit-element.C8p3bJxG.js";class s extends r{constructor(){super(),this.onInput=t=>{const e=Number(t.target.value);this.value=e,this.internals.setFormValue(String(e)),this.dispatchEvent(new CustomEvent("change",{detail:{value:e},bubbles:!0,composed:!0}))},this.min=0,this.max=100,this.step=1,this.size="md",this.label="",this.showValue=!0,this.disabled=!1,this.value=0,this.internals=this.attachInternals()}static{this.formAssociated=!0}static{this.properties={min:{type:Number},max:{type:Number},step:{type:Number},size:{type:String,reflect:!0},label:{type:String},showValue:{type:Boolean,attribute:"show-value"},disabled:{type:Boolean,reflect:!0},value:{type:Number}}}connectedCallback(){super.connectedCallback(),this.internals.setFormValue(String(this.value))}get fillPercent(){return this.max===this.min?0:(this.value-this.min)/(this.max-this.min)*100}render(){return a`
      ${this.label?a`<label class="label">${this.label}</label>`:null}
      <div class="row">
        ...
        ${this.showValue?a`<span class="value">${this.value}</span>`:null}
      </div>
