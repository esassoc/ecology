...
- Derive the tint from the semantic token with `color-mix(in srgb, var(--color-background-success) 8%, var(--color-background-elevation-raised))` — no `-50` ramp dependency.
